<section id="login">
    <div class="mt-40 px-5">
        <form action="{{route('login')}}" method="post" class="w-full lg:w-1/3 rounded-lg p-5 border ml-auto mr-auto flex flex-col">
            @csrf
            @if (session('fail'))
            ...
            <div class="ml-auto mr-auto mb-4">
                <a href="{{ route('home.index') }}" class="font-bold text-2xl text-green-500">
