...
@section('contents')
        ...
        <div class="container">
            <x-public.breadcrumb>
                <x-slot:breadcrumbItem>
                    ...
                    <x-public.breadcrumb-item icon="fas fa-chevron-right" name="Cari" class="gap-2">
                    </x-public.breadcrumb-item>
                    <x-public.breadcrumb-item icon="fas fa-chevron-right" name="{{ $search->get('search') }}" class="gap-2">
                    </x-public.breadcrumb-item>
                </x-slot:breadcrumbItem>
            </x-public.breadcrumb>
        </div>
    ...
    {{-- Search form --}}
    @include('web.public.pages.search-products.sections.search-form')
    

    {{-- Products section start --}}
    @include('web.public.pages.search-products.sections.products-result')
