<section id="search-form">
    <div class="container space-y-8">
        <form method="get" action="{{ route('home.search-products') }}">
            {{-- <x-public.product-search>
                <x-slot:button class="gap-2" buttonName="All" buttonIcon="text-sm fas fa-chevron-down">
                </x-slot:button>
                <x-slot:dropdownItem>
                    <x-public.product-search-dropdownitem></x-public.product-search-dropdownitem>
                </x-slot:dropdownItem>
            </x-public.product-search> --}}
            <div class="flex px-3 w-full lg:w-2/3 mx-auto">
                <button id="dropdown-button" data-dropdown-toggle="dropdown"
                    class="flex-shrink-0 gap-2 z-10 text-sm lg:text-base inline-flex items-center py-2.5 px-4 font-medium text-center text-green-900 bg-green-100 border border-green-300 rounded-l-lg hover:bg-green-200 focus:ring-4 focus:outline-none focus:ring-green-100 dark:bg-green-500 dark:hover:bg-green-600 dark:focus:ring-green-500 dark:text-white dark:border-green-600"
                    type="button">All 
                        ...
                        <li class="list-none">
                            <div class="flex items-center p-2 rounded hover:bg-green-100 dark:hover:bg-green-600">
                                ...
                                <label for="category-4"
                                    class="ml-2 w-full text-sm lg:text-base font-medium text-green-900 rounded dark:text-green-300">All</label>
                            </div>
                        </li>
                        <li class="list-none">
                            <div class="flex items-center p-2 rounded hover:bg-green-100 dark:hover:bg-green-600">
