...
@section('contents')
        ...
        <div class="container">
            <x-public.breadcrumb>
                <x-slot:breadcrumbItem>
                    ...
                    <x-public.breadcrumb-item icon="fas fa-chevron-right" name="Order" class="gap-2">
                    </x-public.breadcrumb-item>
                    <x-public.breadcrumb-item icon="fas fa-chevron-right" name="INV-123123" class="gap-2">
                    </x-public.breadcrumb-item>
                </x-slot:breadcrumbItem>
            </x-public.breadcrumb>
        </div>
    ...
    @include('web.public.pages.order.sections.order')
