...
@section('contents')
        ...
        <div class="container">
            <x-public.breadcrumb>
                <x-slot:breadcrumbItem>
                    ...
                    <x-public.breadcrumb-item link="{{ route('home.cart') }}" icon="fas fa-chevron-right" name="Cart" class="gap-2">
                    </x-public.breadcrumb-item>
                    <x-public.breadcrumb-item icon="fas fa-chevron-right" name="Checkout" class="gap-2">
                    </x-public.breadcrumb-item>
                </x-slot:breadcrumbItem>
            </x-public.breadcrumb>
        </div>
    ...
    @include('web.public.pages.checkout.sections.checkout')
