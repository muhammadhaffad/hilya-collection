            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3 mr-2 overflow-hidden">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span
                            class="ml-1 text-sm lg:text-base font-medium text-green-500 md:ml-2 dark:text-green-300">Dashboard</span>
                    </div>
                </li>
            </ol>
...
@include('web.backoffice.pages.dashboard.sections.dashboard')
@endsection