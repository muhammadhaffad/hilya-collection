                ...
                <div class="flex stocks-input space-x-2">
                    <div class="space-y-2">
                        ...
                        <select type="text" name="stock[{{ $index }}][jenis]" id="gender-{{ $index }}"
                            class="block p-2 w-32 text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option value="1" @selected($input['jenis'] == 1)>LAKI LAKI (DEWASA)</option>
                            <option value="3" @selected($input['jenis'] == 3)>LAKI LAKI (ANAK)</option>
                            <option value="0" @selected($input['jenis'] == 0)>PEREMPUAN (DEWASA)</option>
                            <option value="2" @selected($input['jenis'] == 2)>PEREMPUAN (ANAK)</option>
                        </select>
                    </div>
                    <div class="space-y-2">
                        ...
                        <select type="text" name="stock[{{ $index }}][ukuran]" id="size-{{ $index }}"
                            ...
                            @foreach ($sizes as $size)
                                <option value="{{ $size }}" @selected($input['ukuran'] == $size)>{{ $size }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="space-y-2">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="{{ $input['keterangan'] ? 'block' : 'hidden' }}">
                            <div class="w-full space-x-2 flex">
                                <input type="text" name="stock[{{ $index }}][keterangan]" placeholder="contoh: Tidak termasuk hijab" value="{{ $input['keterangan'] ?? '' }}"
                                    class="block p-2 text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            </div>
                        </div>
                    </div>
                    ...
                    <button class="underline text-xs" onclick="removeForm(this)">
                        ❌ Hapus
                    </button>
                </div>
                @php
