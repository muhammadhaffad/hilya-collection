        ...
        <form action="/admin/add/product" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid lg:grid-cols-5">
                <div class="col-span-4 space-y-5">
                    ...
                    @include('web.backoffice.pages.add-product.sections.add-product-images-form')
                    
                    @include('web.backoffice.pages.add-product.sections.add-product-info-form')
                    
                    @include('web.backoffice.pages.add-product.sections.add-product-prices-form')
                    
                    @include('web.backoffice.pages.add-product.sections.add-product-desc-form')
