...
<script>
    ...
    deleteButton.forEach(function (button) {
        button.addEventListener('click', function (e) {
            ...
            text: "Menghapus brand ini",
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#d33',
            cancelButtonColor: '#3085d6',
            confirmButtonText: 'Iya, hapus brand ini!',
    ...
    let height = window.innerHeight - tableContainer.offsetTop;
    brandTable.style.maxHeight = height+'px';
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3 mr-2 overflow-hidden">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span
                            class="ml-1 text-sm lg:text-base font-medium text-green-500 md:ml-2 dark:text-green-300">Daftar brand</span>
                    </div>
                </li>
            </ol>
...
@include('web.backoffice.pages.brand.sections.brands')
@endsection