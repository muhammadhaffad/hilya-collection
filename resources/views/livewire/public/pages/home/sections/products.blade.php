<div>
    <section id="produk" class="">
        <div class="container space-y-8">
            ...
            @endif
            @if ($total+$limit < 50 && $productTotal > 50)
                <div class="mt-8">
                    <x-public.button-primary buttonName="Lihat lainnya" color="green" id="load-more" class="flex mx-auto"></x-public.button-primary>
                </div>
            @elseif ($productTotal > 50)
                <div class="mt-8 flex w-full">
                    <a href="{{ route('home.all-products') }}"
                        class="self-baseline inline-block rounded-lg mx-auto p-2 bg-blue-500 text-white hover:bg-blue-800 focus:bg-blue-800 focus:font-semibold font-semibold">
                        Lihat Semua
                    </a>
                </div>
            @endif
